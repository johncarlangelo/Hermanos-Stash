...
import { Download, Gauge, Music, Pause, Play, Sparkles } from 'lucide-react'
    ...
    <div className="flex h-full flex-col gap-3 p-4 text-[13px] text-ink overflow-hidden">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 border-b border-line pb-2.5">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-semibold text-[14px]">Audio Loudness & Volume Normalizer</h2>
          <span className="text-[11px] text-faint bg-base px-2 py-0.5 rounded border border-line">
            EBU R128 · Streaming -14 LUFS · True Peak
          </span>
        </div>
